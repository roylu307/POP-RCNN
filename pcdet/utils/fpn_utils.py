...
def get_fpn_config(fpn_cfg):
    
    fpn_name = fpn_cfg.FPN_NAME
    min_level = fpn_cfg.MIN_LEVEL
    max_level = fpn_cfg.MAX_LEVEL
    weight_method = fpn_cfg.WEIGHT_METHOD
    depth_multiplier = fpn_cfg.DEPTH
    with_backslash = fpn_cfg.WITH_BACKSLASH
    with_slash = fpn_cfg.WITH_SLASH
    with_skip_connect = fpn_cfg.WITH_SKIP_CONNECT
    skip_connect_type = fpn_cfg.SKIP_CONNECT_TYPE
    name_to_config = {
